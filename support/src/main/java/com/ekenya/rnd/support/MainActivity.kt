...
import com.ekenya.rnd.support.databinding.ActivityMainSupportBinding
...
//    }
    ...
    private lateinit var binding: ActivityMainSupportBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityMainSupportBinding.inflate(layoutInflater)
