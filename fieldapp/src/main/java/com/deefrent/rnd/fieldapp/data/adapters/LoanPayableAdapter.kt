...
class LoanPayableAdapter(private val callBack: LoanPayableCallBack, val context: Context, private val items:List<RepayableLoan>): RecyclerView.Adapter<LoanPayableAdapter.LoanPayableViewHolder>() {
