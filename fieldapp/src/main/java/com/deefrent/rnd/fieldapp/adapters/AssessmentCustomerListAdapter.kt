...
class AssessmentCustomerListAdapter(val items:ArrayList<CustomerInfo>, private val callback: CustomerInfoCallback): RecyclerView.Adapter<AssessmentCustomerListAdapter.IncompleteViewHolder>() {
