...
public class GetFingerPrintReaderActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.deefrent.rnd.common.R.layout.activity_get_reader_list);

        m_back = (Button) findViewById(com.deefrent.rnd.common.R.id.back);
        ...
        if (nSize > 1) {
            ...
            m_readers = (ListView) findViewById(com.deefrent.rnd.common.R.id.list);
