...
import com.deefrent.rnd.fieldapp.ui.existingAccount.CustomerInfoFragment

class CustomerInfoListAdapter(
    private val dashboardItemList: ArrayList<DashboardItem>,
    private val context: Context,
    private val customerInfoFragment: CustomerInfoFragment
):
    RecyclerView.Adapter<CustomerInfoListAdapter.ViewHolder>() {
