...
import com.deefrent.rnd.fieldapp.databinding.FragmentMerchantActiveChannelsBinding
...
class MerchantActiveChannelsFragment : Fragment() {
    private var _binding: FragmentMerchantActiveChannelsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMerchantActiveChannelsBinding.inflate(inflater, container, false)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            MerchantActiveChannelsFragment().apply {
